	...
	public class NecroSummonGump : Gump
	{
		...
		public NecroSummonGump( Mobile from ) : base( 0, 0 )
		{
			...
			switch ( slotlevel )
			{
				...
				case 5:
					SummonButton( 1, 1, (int)Buttons.Ringwraith, "Revenant", 9671 );
					goto case 4;
				...
				case 7:
                    SummonButton(2, 0, (int)Buttons.DaemonOverlord, "Bone Overlord", 0x2628);
					goto case 6;
		...
		public override void OnResponse( Server.Network.NetState sender, RelayInfo info )
		{
            ...
            {
                m_Player.SendMessage("You cannot begin to summon yet.");
                return;
            }
			switch ( info.ButtonID )
			{
				...
				case (int)Buttons.Ghoul:
								...
								if ( bones && gravedust )
								{
									...
									Summonicate( m_Player, typeof( Zombie ), "Ghoul", 100, 3, 15, 45 );
									m_Player.Mana -= 40;
									break;
				...
				case (int)Buttons.ChaosWarrior:
								...
								if ( noxcrystal && gravedust )
								{
									...
									Summonicate( m_Player, typeof( ChaosDaemon ), "Chaos Warrior", 140, 5, 20, 50 );
									m_Player.Mana -= 50;
									break;
								}
				...
				case (int)Buttons.Ringwraith:
								...
								if ( batwings && noxcrystal )
								{
									...
									Summonicate( m_Player, typeof( Wraith ), "Revenant", 170, 7, 20, 60 );
									m_Player.Mana -= 60;
									break;
								}
				...
				case (int)Buttons.MummyLord:
								...
								if ( gravedust && noxcrystal && bones )
								{
									...
									Summonicate( m_Player, typeof( Mummy ), "Mummy Lord", 200, 8, 25, 60 );
									m_Player.Mana -= 60;
									break;
				...
				case (int)Buttons.DaemonOverlord:
								...
								if ( daemonbones && noxcrystal && rubies )
								{
									...
									Summonicate( m_Player, typeof( BoneDemon ), "Bone Overlord", 300, 10, 30, 70 );
									m_Player.Mana -= 110;
									break;
								}
