...
{
	[CorpseName( "a Rothe corpse" )]
	public class Rothe : BaseCreature, ICarvable
	{
		...
		[Constructable]
		public Rothe() : base( AIType.AI_Animal, FightMode.Agressor, 10, 1, 0.2, 0.4 )
		{
			Name = "a rothe";
			Body = 0xCF;
			BaseSoundID = 0xD6;
		...
		public Rothe( Serial serial ) : base( serial )
		{
		}
