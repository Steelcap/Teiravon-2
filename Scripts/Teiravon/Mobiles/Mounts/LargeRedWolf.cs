...
namespace Server.Mobiles
{
	...
	public class LargeRedWolf : BaseMount
	{
		[Constructable]
		public LargeRedWolf() : base( "a large red wolf", 277, 16017, AIType.AI_Melee, FightMode.Agressor, 10, 1, 0.1, 0.3 )
		{
			BaseSoundID = 0xE5;
		...
		public LargeRedWolf( Serial serial ) : base( serial )
		{
		}
