...
namespace Server.Mobiles
{
	...
	public class LargeGreyWolf : BaseMount
	{
		[Constructable]
		public LargeGreyWolf() : base( "a large grey wolf", 277, 16017, AIType.AI_Melee, FightMode.Agressor, 10, 1, 0.1, 0.3 )
		{
			BaseSoundID = 0xE5;
			Hue = 2301;
		...
		public LargeGreyWolf( Serial serial ) : base( serial )
		{
		}
