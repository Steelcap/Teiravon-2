...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public MithrilElemental() : this( 2 )
		{
		}

		[Constructable]
		public MithrilElemental( int oreAmount ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			// TODO: Gas attack
			...
			PackItem( new MithrilOre( oreAmount ) );
		}
