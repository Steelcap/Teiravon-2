...
namespace Server.Engines.Harvest
{
	public class Mining : HarvestSystem
	{
		...
		private Mining()
		{
			...
			// Every bank holds from 34 to 60 ore
			oreAndStone.MinTotal = 34;
			oreAndStone.MaxTotal = 60;

			// A resource bank will respawn its content every 10 to 20 minutes
			oreAndStone.MinRespawn = TimeSpan.FromMinutes( 40.0 );
			...
			res = new HarvestResource[]
				{
					...
					new HarvestResource( 100.0, 60.0, 140.0, "you dig some mithril ore and put it in your backpack", typeof( MithrilOre ),		typeof( MithrilGranite ),		typeof( MithrilElemental ) ),
					new HarvestResource( 100.0, 60.0, 140.0, "you dig some bloodrock ore and put it in your backpack", typeof( BloodrockOre ),		typeof( BloodrockGranite ),		typeof( BloodrockElemental ) ),
					new HarvestResource( 100.0, 60.0, 140.0, "you dig some steel ore and put it in your backpack", typeof( SteelOre ),		typeof( SteelGranite ),		typeof( SteelElemental ) ),
					new HarvestResource( 100.0, 60.0, 140.0, "you dig some adamantite ore and put it in your backpack", typeof( AdamantiteOre ),		typeof( AdamantiteGranite ),		typeof( AdamantiteElemental ) ),
					new HarvestResource( 100.0, 60.0, 140.0, "you dig some ithilmar ore and put it in your backpack", typeof( IthilmarOre ),		typeof( IthilmarGranite ),		typeof( IthilmarElemental ) )
				};

			veins = new HarvestVein[]
				{
					new HarvestVein( 49.0, 0.0, res[0], null   ), // Iron
					...
					new HarvestVein( 05.6, 0.5, res[5], res[0] ), // Silver
					new HarvestVein( 04.2, 0.5, res[6], res[0] ), // Gold
					new HarvestVein( 02.8, 0.5, res[7], res[0] ), // Agapite
					new HarvestVein( 01.4, 0.5, res[8], res[0] ), // Verite
					new HarvestVein( 00.6, 0.5, res[9], res[0] ),  // Valorite
					new HarvestVein( 00.0, 0.5, res[10], res[0] ),  // Mithril
					new HarvestVein( 00.0, 0.5, res[11], res[0] ),  // Bloodrock
					new HarvestVein( 00.0, 0.5, res[12], res[0] ),  // Steel
					new HarvestVein( 00.0, 0.5, res[13], res[0] ), // Adamantite 
                    new HarvestVein( 00.0, 0.5, res[14], res[0] ) // Ithilmar
				};
            */

            res = new HarvestResource[]
				{
					new HarvestResource( 00.0, 00.0, 60.0, "you dig some ferite ore and put it in your backpack", typeof( TAVOre.FeriteOre ),			typeof( Granite ) ), 
                    			new HarvestResource( 10.0, 10.0, 80.0, "you dig some malachite ore and put it in your backpack", typeof( TAVOre.MalachiteOre ),			typeof( Granite ),  typeof(CopperElemental)),
					new HarvestResource( 20.0, 20.0, 100.0, "you dig some pyrite ore and put it in your backpack", typeof( TAVOre.PyriteOre ),			typeof( Granite ),  typeof(GoldenElemental)),
                    			new HarvestResource( 30.0, 30.0, 110.0, "you dig some umbrite ore and put it in your backpack", typeof( TAVOre.UmbriteOre ),			typeof( Granite ),  typeof(ShadowIronElemental) ),
                    			new HarvestResource( 40.0, 40.0, 120.0, "you dig some amirite ore and put it in your backpack", typeof( TAVOre.AmiriteOre ),			typeof( Granite ),  typeof(SilverElemental) ),
				};

            			veins = new HarvestVein[]
				{
					new HarvestVein( 45.0, 0.0, res[0], null   ), // Ferite
					new HarvestVein( 20.0, 0.0, res[1], null ), // Malachite
					new HarvestVein( 20.0, 0.0, res[2], null ), // Pyrite
					new HarvestVein( 10.0, 0.0, res[3], null ), // Umbrite
					new HarvestVein( 5.0, 0.0, res[4], null ), // Amirite
				};
			...
			res = new HarvestResource[]
				{
					new HarvestResource( 20.0, 15.0, 50.0, 1044631, typeof( Sand ) )
				};
		...
		public override Type GetResourceType( Mobile from, Item tool, HarvestDefinition def, Map map, Point3D loc, HarvestResource resource )
		{
			...
			{
				if ( from is PlayerMobile && ((PlayerMobile)from).ToggleMiningStone && from.Skills[SkillName.Mining].Base >= 60.0 && 0.1 > Utility.RandomDouble() )
		...
		public override bool CheckHarvest( Mobile from, Item tool, HarvestDefinition def, object toHarvest )
		{
			...
			if ( def == m_Sand && !(from is PlayerMobile && from.Skills[SkillName.Mining].Base >= 20.0) )
			{
		...
		{
			if ( tool is GargoylesPickaxe || tool is DwarvenPickaxe && def == m_OreAndStone )
			{
