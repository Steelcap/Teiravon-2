...
namespace Server.Engines.BulkOrders
{
	...
	public abstract class SmallBOD : Item
	{
		...
		{
			Weight = 1.0;
			Hue = hue; // Blacksmith: 0x44E; Tailoring: 0x483; Fletching: 0x20
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			try
			{
				Item m_Item = (Item)Activator.CreateInstance( m_Type );

				if ( m_Item.Name == null )
					list.Add( 1060658, "#{0}\t{1}", m_Number, m_AmountCur );
				else
					list.Add( m_Item.Name+ ": " +m_AmountCur );
		...
		public static BulkMaterialType GetMaterial( CraftResource resource )
		{
			switch ( resource )
			{
				...
				case CraftResource.WhitePine:		return BulkMaterialType.WhitePine;
				case CraftResource.Ashwood:			return BulkMaterialType.Ashwood;
				case CraftResource.SilverBirch:		return BulkMaterialType.SilverBirch;
				case CraftResource.Yew:				return BulkMaterialType.Yew;
				case CraftResource.BlackOak:		return BulkMaterialType.BlackOak;
		...
		public void EndCombine( Mobile from, object o )
		{
			if ( o is Item && ((Item)o).IsChildOf( from.Backpack ) )
			{
				...
				else
				{
					...
					else if ( m_Material >= BulkMaterialType.Pine && m_Material <= BulkMaterialType.BlackOak && material != m_Material )
					{
					...
					else
					{
						...
						if ( o is BaseWeapon )
							...
							isExceptional = ( ((BaseRanged)o).Quality == WeaponQuality.Exceptional );
