...
*/
			...
			AddButton( 80, 90, 5540, 5541, 1, GumpButtonType.Reply, 0 );
			AddHtml( 110, 90, 450, 74, @"<u>General question about Teiravon not answered on the website OR forums.</u>", true, true );

			AddButton( 80, 170, 5540, 5541, 7, GumpButtonType.Reply, 0 );
			AddHtml( 110, 170, 450, 74, @"<u>Another player is harassing me.</u> Another player is verbally harassing your character.", true, true );

			AddButton( 80, 250, 5540, 5541, 3, GumpButtonType.Reply, 0 );
			AddHtml( 110, 250, 450, 74, @"<u>Report a bug.</u> Use this option to report CRITICAL bugs, otherwise post a bug report on Bugs Forum.", true, true );
