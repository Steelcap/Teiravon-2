...
namespace Server.Engines.Craft
{
	public class Repair
	{
		...
		private class InternalTarget : Target
		{
			...
			private bool IsSpecialArmor( Item armor )
			{
				if ( ( armor is DwarvenGloves ) || ( armor is DwarvenLeatherChest )
					|| ( armor is DwarvenLeatherLegs ) || ( armor is DwarvenLeatherArms )
					|| ( armor is DwarvenLeatherCap ) || ( armor is DwarvenLeatherGloves )
					|| ( armor is DwarvenLeatherGorget ) )
					return true;
