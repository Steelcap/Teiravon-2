...
namespace Server.Engines.Reports
{
	...
	public class BarGraphRenderer : ChartRenderer
	{
		...
		private const float	_labelFontSize = 10f;
		private const int	_legendFontSize = 11;
		private const float _legendRectangleSize = 15F;
...
//					sfVLabel.FormatFlags=StringFormatFlags.DirectionVertical;
		...
		private void AssignDefaultSettings()
		{
            ...
            _backColor = Color.FromArgb(100, Color.Beige); ;
