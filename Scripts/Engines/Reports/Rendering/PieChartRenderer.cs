...
namespace Server.Engines.Reports
{
	...
	{
		private const int	_bufferSpace = 150;
		...
		public PieChartRenderer()
		{
			...
			_perimeter = 270;
            _backgroundColor = Color.FromArgb(100,Color.Beige);
			_borderColor = Color.FromArgb(93,93,93);
			_legendFontSize = 12;
			//_legendFontStyle = "Verdana";
            _legendFontStyle = "Helvetica";
		}
		...
		private void CalculateLegendWidthHeight()
		{
			...
			_legendFontHeight = fontLegend.Height+4;
