...
namespace Server.Mobiles
{
	...
	{
		public static double Chance      = .015;         // Chance that a newly spawned creature will be a paragon
		public static double ChestChance = .75;         // Chance that a paragon will carry a paragon chest
		...
		public static bool CheckConvert( BaseCreature bc, Point3D location, Map m )
		{
            ...
            if (bc.TreasureMapLevel < 1)
                return false;
            
            Regions.TeiravonRegion r = bc.Region as Regions.TeiravonRegion;
		...
		public static void GiveArtifactTo( Mobile m )
		{
			...
			if ( m.AddToBackpack( item ) )
				m.SendMessage( "You discover a magical item upon the slain creature, it has been placed in your backpack." );
			else
