    ...
    public class NecroAI : BaseAI
    {
        ...
        public virtual Spell GetRandomDamageSpell()
        {
            ...
            switch (Utility.Random(maxCircle * 2))
            {
                ...
                case 4:
                case 5: return new PainSpikeSpell(m_Mobile, null);
                case 6:
                case 7: return new PoisonStrikeSpell(m_Mobile, null);
                case 8:
                case 9: return new BloodOathSpell(m_Mobile, null);
                case 10: return new StrangleSpell(m_Mobile, null);
                case 11: return new WitherSpell(m_Mobile, null);
