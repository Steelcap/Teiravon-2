...
namespace Server.Mobiles
{
	public class CustomHairstylist : BaseVendor
	{
		...
		private static HairstylistBuyInfo[] m_SellList = new HairstylistBuyInfo[]
			{
				new HairstylistBuyInfo( "New Hair (20 gold)", 20, Layer.Hair, typeof( ChangeHairstyleGump ), new object[]
					{ From, Vendor, Price, Layer.Hair, ChangeHairstyleEntry.HairEntries } ),
				new HairstylistBuyInfo( "New Beard (20 gold)", 20, Layer.FacialHair, typeof( ChangeHairstyleGump ), new object[]
				...
				//new HairstylistBuyInfo( 1018360, 100, Layer.Hair, typeof( ChangeHairHueGump ), new object[]
				//	{ From, Vendor, Price, new Layer[]{ Layer.Hair, Layer.FacialHair }, ChangeHairHueEntry.BrightEntries } ),
				new HairstylistBuyInfo( "Dye Hair (10 gold)", 10, Layer.Hair, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, new Layer[]{ Layer.Hair }, ChangeHairHueEntry.RegularEntries } ),
				new HairstylistBuyInfo( "Dye Beard (10 gold)", 10, Layer.FacialHair, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, new Layer[]{ Layer.FacialHair }, ChangeHairHueEntry.RegularEntries } ),
				//new HairstylistBuyInfo( 1018363, 100, Layer.Hair, typeof( ChangeHairHueGump ), new object[]
				//	{ From, Vendor, Price, new Layer[]{ Layer.Hair }, ChangeHairHueEntry.BrightEntries } ),
				//new HairstylistBuyInfo( 1018364, 100, Layer.FacialHair, typeof( ChangeHairHueGump ), new object[]
