...
namespace Server.Mobiles
{
	public class SBCook : SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{
				Add( new GenericBuyInfo( typeof( CheeseWheel ), 12, 20, 0x97E, 0 ) );
				Add( new GenericBuyInfo( "1044567", typeof( Skillet ), 1, 20, 0x97F, 0 ) );
				...
				// TODO: Muffin @ 3gp
				Add( new GenericBuyInfo( typeof( JarHoney ), 1, 20, 0x9EC, 0 ) );
				Add( new GenericBuyInfo( typeof( SackFlour ), 1, 20, 0x1039, 0 ) );
				//Add( new GenericBuyInfo( typeof( BreadLoaf ), 7, 20, 0x103B, 0 ) );
				Add( new GenericBuyInfo( typeof( FlourSifter ), 1, 20, 0x103E, 0 ) );
				//Add( new GenericBuyInfo( typeof( BakedPie ), 7, 20, 0x1041, 0 ) );
				Add( new GenericBuyInfo( typeof( RollingPin ), 1, 20, 0x1043, 0 ) );
