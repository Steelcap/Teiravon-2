...
namespace Server.Items
{
	...
	public class MonsterStatuette : Item, Engines.VeteranRewards.IRewardItem
	{
		...
		public bool IsOwner( Mobile mob )
		{
			...
			return ( house != null && house.IsOwner( mob ) || staticHouse != null && staticHouse.IsOwner( mob ));
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendMessage( "The statue must be locked down and activated by the house owner" ); // You must be the owner to use this.
			}
		}
