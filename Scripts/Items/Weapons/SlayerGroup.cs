...
namespace Server.Items
{
	public class SlayerGroup
	{
		...
		static SlayerGroup()
		{
            ...
            undead.Super = new SlayerEntry(SlayerName.Silver, typeof(FleshGolem), typeof( PatchworkSkeleton ), typeof(SkeletalMage), typeof(BoneMagi), typeof(WailingBanshee), typeof(SkeletalMount), typeof(MoundOfMaggots), typeof(AncientLich), typeof(Bogle), typeof(BoneMagi), typeof(Lich), typeof(LichLord), typeof(Shade), typeof(Spectre), typeof(Wraith), typeof(BoneKnight), typeof(Ghoul), typeof(Mummy), typeof(SkeletalKnight), typeof(Skeleton), typeof(Zombie), typeof(ShadowKnight), typeof(DarknightCreeper), /* typeof( RevenantLion ),*/ typeof(RottingCorpse), typeof(SkeletalDragon));
