...
namespace Server.Items
{
    public class Corpse : Container, ICarvable
    {
        ...
        private TransformGroup m_ShiftType = TransformGroup.Impossible; // What kind of fool am I?
        ...
        private bool m_Looted;              // Has anyone taken anything from this corpse?
        private bool m_Scavenged;           // Has a theif scavenged this corpse?
        ...
        {
            get { return m_Scavenged; }
            set { m_Scavenged = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public TransformGroup ShiftType
        {
            get { return m_ShiftType; }
            set { m_ShiftType = value; }
        }
        ...
        private static TimeSpan m_DefaultDecayTime = TimeSpan.FromHours(24);
        ...
        public void BeginDecay(TimeSpan delay)
        {
            if (m_DecayTimer != null)
                m_DecayTimer.Stop();
            if (this.m_Owner is TeiravonMobile && this.TotalItems > 3)
                return;
            else
            {
            ...
            : base(0x2006)
        {
            ...
            BeginDecay(m_Owner.Player? m_DefaultDecayTime : m_BoneDecayTime);
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write((bool)m_Scavenged);
            writer.Write((bool)m_Looted);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                case 12:
                    {
                        m_Scavenged = reader.ReadBool();

                        goto case 11;
                    }
                case 11:
                    {
                        m_Looted = reader.ReadBool();
        ...
        public bool CanLoot(Mobile from)
        {
            ...
            Party m_Party = from.Party as Party;

            if (m_Owner is PlayerMobile && Looted && from.AccessLevel <= AccessLevel.Player && !m_Party.Contains(m_Owner))
                return false;
