...
namespace Server.Items
{
	public class Bola : Item
	{
		...
		private static void FinishThrow( object state )
		{
			...
			if (from is TeiravonMobile && to is TeiravonMobile)
			{
				TeiravonMobile tmd = (TeiravonMobile)to;
				TeiravonMobile tma = (TeiravonMobile)from;
				...
				if (Utility.Random(100) < 50 + adj)
				{
					...
					from.SendMessage("Your dismount attempt fails.");
					return;
				}
			}
