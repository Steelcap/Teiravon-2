	...
	public abstract class BaseContainer : Container
	{
		...
		public override void AddNameProperty( ObjectPropertyList list )
		{
			...
			switch ( m_Resource )
			{
				...
				case CraftResource.Oak:			oreName = "Oak"; break;
				case CraftResource.Pine:		oreName = "Pine"; break;
				case CraftResource.Redwood:		oreName = "Redwood"; break;
				case CraftResource.WhitePine:		oreName = "White Pine"; break;
				case CraftResource.Ashwood:		oreName = "Ashwood"; break;
				case CraftResource.SilverBirch:		oreName = "Silver Birch"; break;
				case CraftResource.Yew:			oreName = "Yew"; break;
				case CraftResource.BlackOak:		oreName = "Black Oak"; break;
				default: oreName = null; break;
			}
		...
		{
			return Movable || !Movable || IsLockedDown || IsSecure || m == Parent;
		}
