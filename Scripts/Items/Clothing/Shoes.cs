...
namespace Server.Items
{
    ...
    public class TravelingBoots : BaseShoes
    {
        [Constructable]
        public TravelingBoots() : this(0) { }

        [Constructable]
        public TravelingBoots(int hue)
            : base(0x3d95, hue)
        {
            Weight = 3.0;
        ...
        public TravelingBoots(Serial serial) : base(serial) { }
    ...
    public class HeeledBoots : BaseShoes
    {
        [Constructable]
        public HeeledBoots() : this(0) { }

        [Constructable]
        public HeeledBoots(int hue)
            : base(0x3d77, hue)
        {
            Weight = 3.0;
            Name = "Heeled Boots";
        ...
        public HeeledBoots(Serial serial) : base(serial) { }
