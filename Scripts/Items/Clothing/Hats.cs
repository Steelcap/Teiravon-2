...
namespace Server.Items
{
    ...
    public class HoodedCape : BaseHat
    {
        [Constructable]
        public HoodedCape() : this(0) { }

        [Constructable]
        public HoodedCape(int hue)
            : base(0x030a, hue)
        {
            Weight = 1.0;
            Name = "Hooded Cape";
        ...
        public HoodedCape(Serial serial) : base(serial) { }
	...
	public class HoodedCloak : BaseHat
    {
        [Constructable]
        ...
        public HoodedCloak(Serial serial) : base(serial) { }
