...
namespace Server.Items
{
	public class ProspectorsTool : BaseBashing, IUsesRemaining
	{
		...
		public void Prospect( Mobile from, object toProspect )
		{
			...
			{
				from.SendMessage( "You cannot this vein through prospecting." ); // You cannot improve valorite ore through prospecting.
			}
			else
			{
                ...
                switch (veinIndex + 1)
                {
                    default: from.SendMessage("You sift through the ore and find ferite deposits.");break;
                    case 0: from.SendMessage("You sift through the ore and find ferite deposits."); break;
                    case 1: from.SendMessage("You sift through the ore and find malachite deposits."); break;
                    case 2: from.SendMessage("You sift through the ore and find pyrite deposits."); break;
                    case 3: from.SendMessage("You sift through the ore and find umbrite deposits."); break;
                    case 4: from.SendMessage("You sift through the ore and find amirite deposits."); break;
                }
				--UsesRemaining;
