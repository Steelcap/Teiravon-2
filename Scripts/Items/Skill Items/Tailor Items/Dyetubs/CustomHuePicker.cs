...
//new hue group for armor
		public static readonly CustomHuePicker ArmorEnamelKit = new CustomHuePicker( new CustomHueGroup[]
			{
				/* Dull Copper */
				new CustomHueGroup( 1018332, new int[]{ 2419, 2420, 2421, 2422, 2423, 2424 } ),
				/* Shadow Iron */
				...
				new CustomHueGroup( 1018340, new int[]{ 2113, 2114, 2115, 2116, 2117, 2118 }),
				/* Specials */
				new CustomHueGroup( "Special", new int[]{ 2225, 201, 438, 253, 277, 321 }),
			}, true );
//end new hue group for armor
