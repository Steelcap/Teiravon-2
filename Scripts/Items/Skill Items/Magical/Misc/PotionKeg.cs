...
namespace Server.Items
{
	public class PotionKeg : Item
	{
		...
		public override int LabelNumber{ get{ return (m_Held > 0 ? 1041620 + (int)m_Type - 1: 1041641); } }

		public override void GetProperties( ObjectPropertyList list )
		{

			if ( (int)m_Type > 19 && (m_TypeName != null) )
				list.Add( "A Keg Of {0}s ", m_TypeName );
			else if ( (int)m_Type > 20 && m_TypeName == null )
				list.Add( "A Keg of Unknown Potions" );
			else
		...
		public BasePotion FillBottle()
		{
			switch ( m_Type )
			{
				...
				case PotionEffect.GenderSwap:		return new GenderSwapPotion();

				case PotionEffect.Sustenance:		return new SustenancePotion();

				case PotionEffect.GreaterSustenance:	return new GreaterSustenancePotion();

				case PotionEffect.GreaterFloat:		return new GreaterFloatPotion();

				case PotionEffect.Float:		return new FloatPotion();

				case PotionEffect.LesserFloat:		return new LesserFloatPotion();

				case PotionEffect.Chameleon:		return new ChameleonPotion();
			}
		}
