...
namespace Server.Items
{
    ...
    [FlipableAttribute(0x1079, 0x1078)]
    public class ScaledHides : BaseHides, IScissorable
    {
        [Constructable]
        public ScaledHides()
            : this(1)
        ...
        [Constructable]
        public ScaledHides(int amount)
            : base(CraftResource.ScaledLeather, amount)
        {
        }

        public ScaledHides(Serial serial)
            : base(serial)
        {
        }
        ...
        public override Item Dupe(int amount)
        {
            return base.Dupe(new ScaledHides(amount), amount);
        }
        ...
        public bool Scissor(Mobile from, Scissors scissors)
        {
            ...
            base.ScissorHelper(from, new ScaledLeather(), 1);
    ...
    [FlipableAttribute(0x1079, 0x1078)]
    public class TuftedHides : BaseHides, IScissorable
    {
        [Constructable]
        public TuftedHides()
            : this(1)
        ...
        [Constructable]
        public TuftedHides(int amount)
            : base(CraftResource.TuftedLeather, amount)
        {
        }

        public TuftedHides(Serial serial)
            : base(serial)
        {
        }
        ...
        public override Item Dupe(int amount)
        {
            return base.Dupe(new TuftedHides(amount), amount);
        }
        ...
        public bool Scissor(Mobile from, Scissors scissors)
        {
            ...
            base.ScissorHelper(from, new TuftedLeather(), 1);
