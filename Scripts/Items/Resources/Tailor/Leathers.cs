...
namespace Server.Items
{
    ...
    [FlipableAttribute(0x1081, 0x1082)]
    public class ScaledLeather : BaseLeather
    {
        [Constructable]
        public ScaledLeather()
            : this(1)
        {
        }

        [Constructable]
        public ScaledLeather(int amount)
            : base(CraftResource.ScaledLeather, amount)
        {
        }

        public ScaledLeather(Serial serial)
            : base(serial)
        {
        }
        ...
        public override Item Dupe(int amount)
        {
            return base.Dupe(new ScaledLeather(amount), amount);
        }
    }


    [FlipableAttribute(0x1081, 0x1082)]
    public class TuftedLeather : BaseLeather
    {
        [Constructable]
        public TuftedLeather()
            : this(1)
        {
        }

        [Constructable]
        public TuftedLeather(int amount)
            : base(CraftResource.TuftedLeather, amount)
        {
        }

        public TuftedLeather(Serial serial)
            : base(serial)
        {
        }
        ...
        public override Item Dupe(int amount)
        {
            return base.Dupe(new TuftedLeather(amount), amount);
        }
    }
