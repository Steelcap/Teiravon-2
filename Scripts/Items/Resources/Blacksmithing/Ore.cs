...
namespace Server.Items
{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( IsForge( targeted ) )
				{
					...
					switch ( m_Ore.Resource )
					{
						...
						case CraftResource.Mithril: difficulty = 101.0; break;
						case CraftResource.Bloodrock: difficulty = 101.0; break;
						case CraftResource.Steel: difficulty = 101.0; break;
						case CraftResource.Adamantite: difficulty = 101.0; break;
						case CraftResource.Ithilmar: difficulty = 101.0; break;
					}
	...
	public class MithrilOre : BaseOre
	{
		...
		public override Item Dupe( int amount )
		{
			return base.Dupe( new MithrilOre( amount ), amount );
		}
	...
	public class BloodrockOre : BaseOre
	{
		...
		public override Item Dupe( int amount )
		{
			return base.Dupe( new BloodrockOre( amount ), amount );
		}
	...
	public class SteelOre : BaseOre
	{
		...
		public override Item Dupe( int amount )
		{
			return base.Dupe( new SteelOre( amount ), amount );
		}
	...
	public class AdamantiteOre : BaseOre
	{
		[Constructable]
		public AdamantiteOre() : this( 1 )
		{
		}

		[Constructable]
		public AdamantiteOre( int amount ) : base( CraftResource.Adamantite, amount )
		{
		}
		...
		public override Item Dupe( int amount )
		{
			return base.Dupe( new AdamantiteOre( amount ), amount );
		}

		public override BaseIngot GetIngot()
		{
			return new AdamantiteIngot();
		}
	}

	public class IthilmarOre : BaseOre
	{
		[Constructable]
		public IthilmarOre() : this( 1 )
		{
		}

		[Constructable]
		public IthilmarOre( int amount ) : base( CraftResource.Ithilmar, amount )
		{
		}

		public IthilmarOre( Serial serial ) : base( serial )
		{
		}
		...
		public override Item Dupe( int amount )
		{
			return base.Dupe( new IthilmarOre( amount ), amount );
		}

		public override BaseIngot GetIngot()
		{
			return new IthilmarIngot();
		}
	}
    ...
    public class SilverOre : BaseOre
    {
        ...
        public override Item Dupe(int amount)
        {
            return base.Dupe(new SilverOre(amount), amount);
        }
