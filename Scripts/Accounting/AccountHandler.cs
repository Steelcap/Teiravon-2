...
namespace Server.Misc
{
	public class AccountHandler
	{
		...
		private static CityInfo[] StartingCities = new CityInfo[]
			{
				new CityInfo( "Yew",		"The Empath Abbey",		2290, 978, 0  ),
				new CityInfo( "Minoc",		"The Barnacle",			2290, 978, 0 ),
				new CityInfo( "Britain",	"Sweet Dreams Inn",		2290, 978, 0 ),
				new CityInfo( "Moonglow",	"The Scholars Inn",		2290, 978, 0  ),
				new CityInfo( "Trinsic",	"The Traveler's Inn",		2290, 978, 0  ),
				new CityInfo( "Magincia",	"The Great Horns Tavern",	2290, 978, 0 ),
				new CityInfo( "Jhelom",		"The Mercenary Inn",		2290, 978, 0  ),
				new CityInfo( "Skara Brae",	"The Falconer's Inn",		2290, 978, 0 ),
				new CityInfo( "Vesper",		"The Ironwood Inn",		2290, 978, 0  ),
				new CityInfo( "Haven",		"Buckler's Hideaway",		2290, 978, 0 )
			};
