			...
			for ( int i = 0; i < m_Mobiles.Length; i++ )
			{
				...
				if ( m != null && m.Young )
				{
					...
					if ( m.NetState != null )
					{
						...
						m.SendMessage( "You are no longer considered a young player on Teiravon, and thus you are no longer subject to the limitations and benefits of being in that caste." ); // You are no longer considered a young player of Ultima Online, and are no longer subject to the limitations and benefits of being in that caste.
					}
				}
			}
		}
