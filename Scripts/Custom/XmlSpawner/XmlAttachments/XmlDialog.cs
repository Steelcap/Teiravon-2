...
namespace Server.Engines.XmlSpawner2
{
	public class XmlDialog : XmlAttachment
	{
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer( XmlDialog npc, TimeSpan delay, Mobile trigmob ) : base( delay, delay )
			{
		...
		public class ConfirmSaveGump : Gump
		{
			...
			public ConfirmSaveGump(XmlDialog dialog, DataSet ds, string filename, string configname, bool updateconfig) : base ( 0, 0 )
			{
				m_dialog = dialog;
				m_ds = ds;
				m_filename = filename;
		...
		private class SaveNPCTarget : Target
		{
			...
			public SaveNPCTarget( CommandEventArgs e) :  base ( 30, false, TargetFlags.None )
			{
				m_e = e;
			}
		...
		{
			private CommandEventArgs m_e;
			public LoadNPCTarget( CommandEventArgs e) :  base ( 30, false, TargetFlags.None )
			{
				m_e = e;
			}
			protected override void OnTarget( Mobile from, object targeted )
		...
		public new static void Initialize()
		{
            ...
            Server.Commands.Register("SaveNPC", AccessLevel.Administrator, new CommandEventHandler(SaveNPC_OnCommand));
            Server.Commands.Register("LoadNPC", AccessLevel.Administrator, new CommandEventHandler(LoadNPC_OnCommand));
        }
