...
namespace Server.Engines.XmlSpawner2
{
	public class XmlQuestPoints : XmlAttachment
	{
		...
		{
			Server.Commands.Register( "QuestPoints", AccessLevel.Player, new CommandEventHandler( CheckQuestPoints_OnCommand ) );

			Server.Commands.Register( "QuestLog", AccessLevel.Player, new CommandEventHandler( QuestLog_OnCommand ) );
