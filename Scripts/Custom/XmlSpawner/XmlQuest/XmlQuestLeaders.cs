...
namespace Server.Engines.XmlSpawner2
{
	...
	public class XmlQuestLeaders
	{
		...
		public static void Initialize()
		{
			...
			Server.Commands.Register( "QuestLeaderboardSave", AccessLevel.Administrator, new CommandEventHandler( QuestLeaderboardSave_OnCommand ) );
			Server.Commands.Register( "QuestRanking", AccessLevel.Player, new CommandEventHandler( QuestRanking_OnCommand ) );
		}
