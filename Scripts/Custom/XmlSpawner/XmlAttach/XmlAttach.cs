...
namespace Server.Engines.XmlSpawner2
{
	...
	public class XmlAttach
	{
        ...
        public static void Initialize()
        {
			...
			//Server.Commands.Register( "ItemAtt", AccessLevel.GameMaster, new CommandEventHandler( ListItemAttachments_OnCommand ) );
			//Server.Commands.Register( "MobAtt", AccessLevel.GameMaster, new CommandEventHandler( ListMobileAttachments_OnCommand ) );
			Server.Commands.Register( "GetAtt", AccessLevel.GameMaster, new CommandEventHandler( GetAttachments_OnCommand ) );
			//Server.Commands.Register( "DelAtt", AccessLevel.GameMaster, new CommandEventHandler( DeleteAttachments_OnCommand ) );
			//Server.Commands.Register( "TrigAtt", AccessLevel.GameMaster, new CommandEventHandler( ActivateAttachments_OnCommand ) );
			//Server.Commands.Register( "AddAtt", AccessLevel.GameMaster, new CommandEventHandler( AddAttachment_OnCommand ) );
			Server.Scripts.Commands.TargetCommands.Register( new AddAttCommand() );
			Server.Scripts.Commands.TargetCommands.Register( new DelAttCommand() );
			Server.Commands.Register( "AvailAtt", AccessLevel.GameMaster, new CommandEventHandler( ListAvailableAttachments_OnCommand ) );
		}
		...
		public static void CheckOnBeforeKill( Mobile m_killed, Mobile m_killer )
		{
			...
			if(m_killer != null)
			{
				...
				ArrayList equiplist = m_killer.Items;
				if(equiplist != null)
				{
...
//				return;
		...
		public static void EventSink_Speech( SpeechEventArgs args )
		{
			...
			{
			    ArrayList packlist = from.Backpack.Items;
			    if(packlist != null)
			    {
            ...
            // check any equipped items
            ArrayList equiplist = from.Items;
			if(equiplist != null)
			{
			        foreach(Item i in equiplist)
			        {
		...
		public static XmlAttachment FindAttachmentOnMobile( Mobile from, Type type, string name )
		{
			...
			if(from.Backpack != null)
			{
			    ArrayList itemlist = from.Backpack.Items;
			    if(itemlist != null)
			    {
			        foreach(Item i in itemlist)
			        {
        ...
        public static int OnArmorHit(Mobile attacker, Mobile defender, BaseArmor armor, BaseWeapon weapon, int damage)
        {
            int damageTaken = 0;
