...
namespace Server.Engines.XmlSpawner2
{
	public interface IXmlAttachment
	{
		...
		*/
		...
		int OnArmorHit(Mobile attacker, Mobile defender, BaseArmor armor, BaseWeapon weapon, int damageGiven);
	...
	public abstract class XmlAttachment : IXmlAttachment
	{
		...
		*/
		...
		public virtual int OnArmorHit(Mobile attacker, Mobile defender, BaseArmor armor, BaseWeapon weapon, int damageGiven)
		{
			return 0;
		}
