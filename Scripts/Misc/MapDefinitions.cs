...
namespace Server.Misc
{
	public class MapDefinitions
	{
		public static void Configure()
		{
			...
			RegisterMap( 40, 0, 0, 6144, 4096, 0, "Felucca Extra 1",  MapRules.FeluccaRules );
			RegisterMap( 41, 1, 0, 6144, 4096, 0, "Trammel Extra 1",  MapRules.FeluccaRules );
			RegisterMap( 42, 2, 2, 2304, 1600, 1, "Ilshenar Extra 1", MapRules.FeluccaRules );
			RegisterMap( 43, 3, 3, 2560, 2048, 1, "Malas Extra 1",    MapRules.FeluccaRules );
			RegisterMap( 44, 4, 4, 1448, 1448, 1, "Tokuno Extra 1",		MapRules.FeluccaRules );


			RegisterMap( 50, 0, 0, 6144, 4096, 0, "Felucca Extra 2",  MapRules.FeluccaRules );
			RegisterMap( 51, 1, 0, 6144, 4096, 0, "Trammel Extra 2",  MapRules.FeluccaRules );
			RegisterMap( 52, 2, 2, 2304, 1600, 1, "Ilshenar Extra 2", MapRules.FeluccaRules );
			RegisterMap( 53, 3, 3, 2560, 2048, 1, "Malas Extra 2",    MapRules.FeluccaRules );
			RegisterMap( 54, 4, 4, 1448, 1448, 1, "Tokuno Extra 2",		MapRules.FeluccaRules );
