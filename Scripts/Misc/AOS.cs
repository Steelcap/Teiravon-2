...
namespace Server
{
    public class AOS
    {
        ...
        private static bool m_ArmorHalf;

        public static bool IsTracking(Mobile from, Mobile target)
        {
            if (from == null || target == null)
                return false;
            if (from.QuestArrow is TrackArrow)
            {
                TrackArrow t = from.QuestArrow as TrackArrow;
                if (t.Target == target)
                    return true;
            }
            return false;
        ...
        public static bool ArmorHalf
        {
            get { return m_ArmorHalf; }
            set { m_ArmorHalf = value; }
        }
        ...
        {
            return Damage(m, from, damage, phys, fire, cold, pois, nrgy, false,0);
        }
        public static int Damage(Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, int armorIgnore)
        {
            return Damage(m, from, damage, phys, fire, cold, pois, nrgy, false,armorIgnore);
        }
        public static int Damage(Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, bool keepAlive)
        {
            return Damage(m,from,damage,phys,fire,cold,pois,nrgy,keepAlive,0);
        }
