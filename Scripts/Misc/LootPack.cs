...
namespace Server
{
	public class LootPack
	{
		...
		public static Type[] AlchyScroll = new Type[]
		{
		...
		{
			return ( chance > Utility.Random( 5000 ) );
		}
		...
		public void Generate( Mobile from, Container cont, bool spawning, int luckChance )
		{
			...
			for ( int i = 0; i < m_Entries.Length; ++i )
			{
				...
				bool shouldAdd = ( entry.Chance > (Utility.Random( 10000 )- (2 * luckChance)) );
				...
				if ( !shouldAdd && checkLuck )
				{
					...
					if ( LootPack.CheckLuck( luckChance ) )
                        shouldAdd = (entry.Chance > (Utility.Random(10000) - (2 * luckChance)) );
				}
        ...
        public static readonly LootPackItem[] LowFormulaItems = new LootPackItem[]
			{
				new LootPackItem( typeof( NightSightFormula ), 1 ),
                new LootPackItem( typeof( LesserHealFormula ), 1 ),
                new LootPackItem( typeof( LesserPoisonFormula ), 1 ),
                new LootPackItem( typeof( LesserCureFormula ), 1 ),
                new LootPackItem( typeof( LesserExplosionFormula ), 1 ),
                new LootPackItem( typeof( LesserFloatFormula ), 1 )
			};

        public static readonly LootPackItem[] MedFormulaItems = new LootPackItem[]
			{
				new LootPackItem( typeof( AgilityFormula ), 1 ),
                new LootPackItem( typeof( HealFormula ), 1 ),
                new LootPackItem( typeof( StrengthFormula ), 1 ),
                new LootPackItem( typeof( PoisonFormula ), 1 ),
                new LootPackItem( typeof( CureFormula ), 1 ),
                new LootPackItem( typeof( ExplosionFormula ), 1 ),
                new LootPackItem( typeof( RefreshFormula ), 1 ),
                new LootPackItem( typeof( FloatFormula ), 1 ),
                new LootPackItem( typeof( SustenanceFormula ), 1 ),
                new LootPackItem( typeof( ManaRefreshFormula ), 1 )
			};

        public static readonly LootPackItem[] HighFormulaItems = new LootPackItem[]
			{
				new LootPackItem( typeof( GreaterRefreshFormula ), 1 ),
                new LootPackItem( typeof( GreaterHealFormula ), 1 ),
                new LootPackItem( typeof( GreaterStrengthFormula ), 1 ),
                new LootPackItem( typeof( GreaterPoisonFormula ), 1 ),
                new LootPackItem( typeof( GreaterCureFormula ), 1 ),
                new LootPackItem( typeof( GreaterExplosionFormula ), 1 ),
                new LootPackItem( typeof( GreaterAgilityFormula ), 1),
                new LootPackItem( typeof( ChameleonFormula ), 1 ),
                new LootPackItem( typeof( GreaterSustenanceFormula ), 1 ),
                new LootPackItem( typeof( InvisibilityFormula ), 1 ),
                new LootPackItem( typeof( TotalManaRefreshFormula ), 1 ),
                new LootPackItem( typeof( MagicResistFormula ), 1 ),
                new LootPackItem( typeof( InvulnerabilityFormula ), 1 )
			};
		...
		public static readonly LootPack AosPoor = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			10.00, "1d3+0" ),
                new LootPackEntry(  true, Silver,			35.00, "1d3+0" ),
		...
		public static readonly LootPack AosMeager = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			20.00, "1d3+2" ),
                new LootPackEntry(  true, Silver,			45.00, "1d3+2" ),
				//new LootPackEntry( false, MagicItems,	  1.00, 1, 2, 0, 10 ),
				//new LootPackEntry( false, MagicItems,	  0.25, 1, 5, 0, 90 ),
				//new LootPackEntry( false, Instruments,	  0.10, 1 )
			} );

		public static readonly LootPack AosAverage = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			35.00, "1d4+4" ),
                new LootPackEntry(  true, Silver,			55.00, "1d4+4" ),
				//new LootPackEntry( false, MagicItems,	  5.00, 1, 4, 0, 20 ),
				//new LootPackEntry( false, MagicItems,	  1.00, 1, 3, 0, 50 ),
		...
		public static readonly LootPack AosRich = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Gold,         60.00, "1d3+0"),
				new LootPackEntry(  true, Gold,			40.00, "2d4+6" ),
                new LootPackEntry(  true, Silver,			65.00, "2d4+6" ),
				//new LootPackEntry( false, MagicItems,	 20.00, 1, 4, 0, 40 ),
//				new LootPackEntry( false, MagicItems,	 0.50, 1, 5, 0, 60 ),
//				new LootPackEntry( false, MagicItems,	  0.10, 1, 5, 0, 90 ),
				//new LootPackEntry( false, Instruments,	  1.00, 1 )
			} );

		public static readonly LootPack AosFilthyRich = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Gold,         80.00, "50d3+1"),
				new LootPackEntry(  true, Gold,			35.00, "25d4+10" ),
                new LootPackEntry(  true, Silver,			75.00, "3d4+10" ),
				//new LootPackEntry( false, MagicItems,	 33.00, 1, 4, 0, 50 ),
//				new LootPackEntry( false, MagicItems,	 2.00, 1, 4, 0, 60 ),
				//new LootPackEntry( false, MagicItems,	 20.00, 1, 5, 0, 75 ),
//				new LootPackEntry( false, MagicItems,	  0.50, 1, 5, 0, 100 ),
				//new LootPackEntry( false, Instruments,	  2.00, 1 )
			} );

		public static readonly LootPack AosUltraRich = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Gold,         100.00, "100d3+5"),
				new LootPackEntry(  true, Gold,			60.00, "50d6+20" ),
//				new LootPackEntry( false, MagicItems,	50.00, 1, 5, 25, 100 ),
//				new LootPackEntry( false, MagicItems,	20.00, 1, 5, 25, 100 ),
				//new LootPackEntry( false, MagicItems,	100.00, 1, 5, 25, 100 ),
				//new LootPackEntry( false, MagicItems,	100.00, 1, 5, 25, 100 ),
				//new LootPackEntry( false, MagicItems,	100.00, 1, 5, 25, 100 ),
				//new LootPackEntry( false, MagicItems,	10.00, 1, 5, 35, 100 ),
				//new LootPackEntry( false, Instruments,	  2.00, 1 )
			} );

		public static readonly LootPack AosSuperBoss = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "1000d6+50" ),
//				new LootPackEntry( false, MagicItems,	100.00, 1, 5, 25, 100 ),
//				new LootPackEntry( false, MagicItems,	100.00, 1, 5, 25, 100 ),
//				new LootPackEntry( false, MagicItems,	100.00, 1, 5, 25, 100 ),
//				new LootPackEntry( false, MagicItems,	100.00, 1, 5, 25, 100 ),
...
//				new LootPackEntry( false, Instruments,	  2.00, 1 )
		...
		public static readonly LootPack LowScrolls = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, LowScrollItems,	8.00, 1 ),
                new LootPackEntry( false, LowFormulaItems, 16.00,1 ),
                new LootPackEntry( false, MedFormulaItems, 4.00,1 )
			} );

		public static readonly LootPack MedScrolls = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, MedScrollItems,	4.00, 1 ),
                new LootPackEntry( false, MedFormulaItems, 16.00, 1 ),
                new LootPackEntry( false, HighFormulaItems, 8.00, 1 ),
                new LootPackEntry( false, LowFormulaItems,  4.00,1 ),
			} );

		public static readonly LootPack HighScrolls = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, HighScrollItems,	4.00, 1 ),
                new LootPackEntry( false, HighFormulaItems, 32.00, 1 )
			} );

		public static readonly LootPack Gems = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, GemItems,			5.00, 1 )
			} );

		public static readonly LootPack Potions = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, PotionItems,		50.00, 1 )
			} );
	}
